...
export default function UpdateData(props : UpdateDataProps){
    ...
    return <div className={"row"}>
        ...
        <input type="number" placeholder="Primary sucessful (0%) " pattern="[0-9]*" id={"primaryValid"} onKeyPress={teste} min="0" max="100" defaultValue="100"  onChange={updateSchool}/>
        ...
        <input type="number" placeholder="Secondary sucessful (0%)" pattern="[0-9]*" id={"SecondaryValid"} onKeyPress={teste} min="0" max="100" defaultValue="100"  onChange={updateSchool}/>
        ...
        <input type="number" placeholder="High school sucessful (0%)" pattern="[0-9]*" id={"High-schoolValid"} onKeyPress={teste} min="0" max="100" defaultValue="100"  onChange={updateSchool}/>
