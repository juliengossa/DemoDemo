...
function App() {
    ...
    const [schoolData, setSchoolData] = useState<SchoolData>(new SchoolData())
    const [ended, setEnded] = useState(false)

    const reset = () => {
        setGameData(new GameData());
        setSchoolData(new SchoolData());
        setEnded(false);
    }
    ...
    return (
        <>
                ...
                {ended ? (
                    ...
                    <div>
                        <div id="container">
                            <div id="sidebar">
                                <EducationTable gameData={gameData}/>
                                <UpdateData schoolData={schoolData} setScholData={setSchoolData}/>
                            </div>
                            <div id="info">
            ...
            <footer>
                <p>See licence in LICENCE.md</p>
                <p>Created by Tom CZEKAJ, Anatole VOLTZ and Gaël SEILER</p>
            </footer>
        </>
    )
}
